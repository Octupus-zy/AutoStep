...
[![GitHub forks](https://img.shields.io/github/forks/Octupus-zy/AutoStep?style=flat-square)](https://github.com/Octupus-zy/AutoStep/forks)
[![GitHub stars](https://img.shields.io/github/stars/Octupus-zy/AutoStep?style=flat-square)](https://github.com/Octupus-zy/AutoStep/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/Octupus-zy/AutoStep?style=flat-square)](https://github.com/Octupus-zy/AutoStep/issues)
...
### 如果觉得好用，请给一个免费的[star](https://github.com/Octupus-zy/AutoStep/)吧
...
6. 请各位在使用时Fork[当前仓库](https://github.com/Octupus-zy/AutoStep/)，防止出现不必要的bug.
